...
import (
	...
	"github.com/hybridnetwork/hxstakepool/helpers"
	"github.com/hybridnetwork/hxstakepool/models"
	"github.com/hybridnetwork/hxstakepool/poolapi"
...
// which is a problem since there is no testnet2.hybrid.network host.
...
func (controller *MainController) AdminStatus(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "HX Stake Pool - Status (Admin)"
...
func (controller *MainController) AdminTickets(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "HX Stake Pool - Tickets (Admin)"
	c.Env["Content"] = template.HTML(widgets)
